...
const BG_MOVING_SPEED = 2.5; // 배경 이동 속도
let bgX = 0; // 배경 X 좌표
...
bgmSound.src = "./sounds/bgm2.mp3";
const scoreSound = new Audio(); // 점수 획득 소리
scoreSound.src = "./sounds/score.mp3";
const defeatSound = new Audio(); // 게임 오버 소리
defeatSound.src = "./sounds/defeat3.mp3";

/** 이미지 객체 생성 및 설정 */
// (1) 배경
const bgImage = new Image();
bgImage.src = "./images/background4.png";
// (2) 게임 시작
...
const OBSTACLE_HEIGHT = 75; // 장애물 높이
const OBSTACLE_FREQUENCY = 90; // 장애물 생성 빈도
const OBSTACLE_SPEED = 12; // 장애물 이동 속도
